...
public class Driver {
    ...
    POM'de Driver class'indaki getDriver()'nin obje olusturarak kullanilmasini
    engellemek icin
    Singleton pattern kullanimi benimsenmistir

    Singleton Pattern : tekli kullanim, bir class'in farkli classlardan obje
    olusturarak kullanimini engellemek icin kullanilir
